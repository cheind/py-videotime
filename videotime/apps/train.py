...
if __name__ == '__main__':
    ...
    parser.add_argument('--digit-order', type=split, help='Digit order of images', default=np.arange(0,10,dtype=int))  
    ...
    model = vt.TimeDetector.train(imgs, layout=vt.layout_names[args.layout], digitorder=args.digit_order, verbose=args.verbose, xshifts=args.xshifts, yshifts=args.yshifts)
